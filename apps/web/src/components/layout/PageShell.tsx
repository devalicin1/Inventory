  ...
  return (
    <div className={`min-h-full ${className}`}>
      ...
      <div className="px-3 sm:px-4 md:px-6 py-6">
        {/* Header Section */}
        <div className={`flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 ${headerClassName || 'mb-6'}`}>
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-0.5 sm:mb-1">{title}</h1>
            {subtitle && (
